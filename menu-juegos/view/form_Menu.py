...
class Menu:
    def __init__(self, datos_jugador=None, ventana_principal=None):
        super().__init__()
...
# endregion configuracion ventana
    ...
    # region mostrar datos
        ...
        datos_label = tk.Label(frame1, font=("Helvetica", 13, "bold"), bg="#e0592a", foreground="#773dbd", width=40, height=6)
        datos_label.pack()
        datos_label.place(x=50, y=100)
